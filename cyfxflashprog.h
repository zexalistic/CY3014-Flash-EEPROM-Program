...
/* USB vendor request to read SPI flash vendor ID */
#define CY_FX_RQT_SPI_FLASH_ID_READ				(0xC5)

/* USB vendor request to get the firmware version. */
#define CY_FX_RQT_GET_FW_VERSION                (0xC8)

/* USB vendor request to switch to SPI mode */
#define CY_FX_RQT_DISABLE_UART_ENABLE_SPI		(0xC9)
